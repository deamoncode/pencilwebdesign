...
<body <?php body_class(); ?> style=" <?php echo $bg_style; ?> ">
	<div id="page" class="hfeed site">
        ...
        <div class="site-header-top">
            <div class="site-header-account">
            	<ul>
	            	...
	            	<li><a href="<?php echo site_url() . "/cart"; ?>">0 items</a></li>
	            </ul>
	            <a href="#" class="new-project-btn">Start a New Project</a>	
            </div>	
            <div class="clear"></div>
        </div>
        <!--  <div class="headerwrap"> -->
            <header id="masthead" class="site-header" role="banner">
         		<div class="headerinnerwrap">
					<?php if ($iexcel_logo) : ?>
                        <a class="home-link home-link-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
		...
		<?php endif; ?>
		<div id="main" class="site-main-template">
